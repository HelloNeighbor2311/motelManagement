...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">Sửa Thông Tin Giao Dịch</h5>
    </div>
    <div class="card-body">
        @if ($errors->any())
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <select id="LoaiGiaoDich" name="LoaiGiaoDich" class="form-select @error('LoaiGiaoDich') is-invalid @enderror" required>
                        ...
                        <option value="Thu" {{ old('LoaiGiaoDich', $transaction->LoaiGiaoDich) == 'Thu' ? 'selected' : '' }}>Thu (Nhập)</option>
                        <option value="Chi" {{ old('LoaiGiaoDich', $transaction->LoaiGiaoDich) == 'Chi' ? 'selected' : '' }}>Chi (Xuất)</option>
                    </select>
                    @error('LoaiGiaoDich')
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" id="SoTien" name="SoTien" class="form-control @error('SoTien') is-invalid @enderror" 
                           placeholder="Nhập số tiền" value="{{ old('SoTien', $transaction->SoTien) }}" min="0" step="1000" required>
                    @error('SoTien')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" id="NgayGiaoDich" name="NgayGiaoDich" class="form-control @error('NgayGiaoDich') is-invalid @enderror" 
                           value="{{ old('NgayGiaoDich', $transaction->NgayGiaoDich) }}" required>
                    @error('NgayGiaoDich')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" id="ThamChieu" name="ThamChieu" class="form-control @error('ThamChieu') is-invalid @enderror" 
                           placeholder="VD: INV-001, RCP-001" value="{{ old('ThamChieu', $transaction->ThamChieu) }}" maxlength="100">
                    @error('ThamChieu')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 mb-3">
                    ...
                    <textarea id="MoTa" name="MoTa" class="form-control @error('MoTa') is-invalid @enderror" 
                              rows="3" placeholder="Nhập mô tả chi tiết giao dịch" maxlength="500">{{ old('MoTa', $transaction->MoTa) }}</textarea>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" id="Thang" name="Thang" class="form-control @error('Thang') is-invalid @enderror" 
                           placeholder="VD: 6" value="{{ old('Thang', $transaction->Thang) }}" min="1" max="12">
                    @error('Thang')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="number" id="Nam" name="Nam" class="form-control @error('Nam') is-invalid @enderror" 
                           placeholder="VD: 2026" value="{{ old('Nam', $transaction->Nam) }}" min="2000">
                    @error('Nam')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" id="HopDongId" name="HopDongId" class="form-control @error('HopDongId') is-invalid @enderror" 
                           placeholder="Để trống nếu không liên quan" value="{{ old('HopDongId', $transaction->HopDongId) }}">
                    @error('HopDongId')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
