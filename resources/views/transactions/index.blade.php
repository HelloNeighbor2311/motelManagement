				...
				@forelse ($transactions as $t)
					<tr>
						...
						<td style="text-align: center;">
							<a href="{{ route('transactions.show', $t->Id) }}" class="btn btn-sm btn-info" title="Xem"><i class="fas fa-eye"></i></a>
							<a href="{{ route('transactions.edit', $t->Id) }}" class="btn btn-sm btn-warning" title="Sửa"><i class="fas fa-edit"></i></a>
							<button type="button" class="btn btn-sm btn-danger delete-btn" data-id="{{ $t->Id }}" data-url="{{ route('transactions.destroy', $t->Id) }}"><i class="fas fa-trash"></i></button>
						</td>
					</tr>
				@empty
					<tr>
